...
class MLPPolicyPG(MLPPolicy):
    ...
    def run_baseline_prediction(self, obs):
        ...
        sampled_baseline = self.sess.run([self.baseline_prediction], feed_dict={self.observations_pl: observation})[
            0]  # Zohar
    ...
    def update(self, observations, acs_na, adv_n=None, acs_labels_na=None, qvals=None):
        ...
        if self.nn_baseline:
            ...
            self.sess.run([self.baseline_update_op],
                          feed_dict={self.targets_n: targets_n, self.observations_pl: observations})
        return loss
