...
def main():
    ...
    parser.add_argument('--batch_size', type=int, default=100)  # training data collected (in the env) during each iteration
    ...
    parser.add_argument('--learning_rate', '-lr', type=float, default=5e-5)  # LR for supervised learning
